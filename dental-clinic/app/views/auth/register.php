        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <div class="input-wrap" style="position:relative;">
              ...
              <input type="password" id="reg_password" name="password" placeholder="Min. 8 characters" required style="padding-right:40px;">
          ...
          <div class="form-group">
            ...
            <div class="input-wrap" style="position:relative;">
              ...
              <input type="password" id="reg_confirm" name="confirm_password" placeholder="Repeat password" required style="padding-right:40px;">
