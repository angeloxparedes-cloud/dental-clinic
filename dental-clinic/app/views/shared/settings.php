            ...
            <form method="POST" action="?page=change_password">
              ...
              <div class="form-group">
                ...
                <div class="input-wrap">
                  ...
                  <input type="password" name="new_password" required placeholder="Min. 8 characters" id="newPass">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="input-wrap">
                  ...
                  <input type="password" name="confirm_password" required placeholder="Repeat new password" id="confPass">
                </div>
              </div>
