    ...
    <div class="page-content">
      ...
      <div class="card">
        ...
        <div class="table-wrap">
          ...
          <table>
            <thead>
              <tr><th>#</th><th>Patient</th><th>Service</th><th>Appointment</th><th>Amount</th><th>Method</th><th>Reference</th><th>Status</th><th>Action</th></tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <button class="btn btn-ghost btn-sm" onclick="openPayModal(<?= $p['id'] ?>,'<?= $p['status'] ?>')">Update</button>
                </td>
              </tr>
              <?php endforeach; ?>
            </tbody>
    ...
    <form method="POST" action="?page=admin_update_payment">
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="input-wrap no-icon">
            <textarea name="notes" placeholder="e.g. Cash received, GCash confirmed..."></textarea>
          </div>
        </div>
      </div>
