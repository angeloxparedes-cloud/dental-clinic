...
function sendAppointmentEmail($toEmail, $toName, $date, $time, $dentist, $service) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'angeloxparedes@gmail.com'; // gmail account
        $mail->Password   = 'okinpvjoiykmeltd'; // generated app pasword 
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;

        $mail->setFrom('angeloxparedes@gmail.com', 'Auza Dental Clinic');
